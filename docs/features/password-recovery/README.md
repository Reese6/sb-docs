...
| [decisions/adr-001-otp-vs-recovery-link.md](decisions/adr-001-otp-vs-recovery-link.md) | proposed | ADR: OTP вместо ссылки восстановления |
...
Все документы в статусе draft; ADR-001 — proposed. Ключевые открытые вопросы: срок жизни OTP (ASSUMPTION), интервал повторной отправки (TBD), политика паролей (TBD) — полный список в Open Questions документов [requirements.md](requirements.md) и [technical.md](technical.md).
